        ...
        <div @click.stop class="mx-2 bg-white rounded-lg p-5 max-w-[400px]">
            <div v-if="showEnterPhoneDialog">
                ...
                <p class="text-xs mt-4">
                    ...
                    <router-link to="agreement" @click="hideDialog(); $emit('closeMenuModal', true);" class="font-bold hover:border-b hover:border-black">пользовательским соглашением</router-link>
                    и <router-link to="privacy" @click="hideDialog(); $emit('closeMenuModal', true);" class="font-bold hover:border-b hover:border-black">политикой обработки персональных данных</router-link>.
                </p>
            </div>
